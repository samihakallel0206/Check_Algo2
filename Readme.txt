...
- Deux boucle imbriquees ou dans la premiere on utilise un bouleen temoin 
...
- a la sortie des deux boucles on aura trouve les element qui n' existe pas dans le second et on les a sommé
